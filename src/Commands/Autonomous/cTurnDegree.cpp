...
cTurnDegree::cTurnDegree(float targetAngle)
{
    ...
    m_superGoodGyro = CommandBase:: s_drivebase->getGyro();
    this->m_pidController = new PIDController(TURNDEGREE_PID_P, TURNDEGREE_PID_I, TURNDEGREE_PID_D ,m_superGoodGyro, m_motorGroupGyro);
