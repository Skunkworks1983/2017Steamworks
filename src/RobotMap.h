...
const int DRIVEBASE_LEFTMOTOR_1_PORT = 0; //back
const int DRIVEBASE_LEFTMOTOR_2_PORT = 1; //mid
const int DRIVEBASE_LEFTMOTOR_3_PORT = 12; //front

const int DRIVEBASE_RIGHTMOTOR_1_PORT = 15; //back
const int DRIVEBASE_RIGHTMOTOR_2_PORT = 14; //mid
const int DRIVEBASE_RIGHTMOTOR_3_PORT = 13; //front
